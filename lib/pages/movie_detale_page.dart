...
class MovieDetalePage extends StatelessWidget {
  ...
  MovieDetaleModel thing = MovieDetaleModel(
    recomendation: RecomendationModel(results: Get.find<HomeController>().popularMovies.results),
    isError: false,
      cast: CastModel(
          cast: [Cast(
    id: 5,
    name: 'thing',
    profilePath: 'https://www.themoviedb.org/t/p/w300_and_h450_bestv2/grsIJAo7a37SAVl3La5aaUFpVla.jpg',
    character: 'thing',
    creditId: '',
  ),
  Cast(
    id: 5,
    name: 'boy',
    profilePath: 'https://www.themoviedb.org/t/p/w300_and_h450_bestv2/wr9Q5IiRpKl10IuJhDmC7QXDuqz.jpg',
    character: 'bou',
    creditId: '',
  ),
  Cast(
  ...
  Cast(
    id: 5,
    name: 'man',
    profilePath: 'https://www.themoviedb.org/t/p/w300_and_h450_bestv2/jZhHfPt9HUyVdXuTvGLlcnympE5.jpg',
    character: 'man',
    creditId: '',
  ),
  Cast(
    id: 5,
    name: 'tom',
    profilePath: 'https://www.themoviedb.org/t/p/w300_and_h450_bestv2/8vxcFlUeIwNH0uIoZq34uagaLAr.jpg',
    character: 'tom',
    creditId: '',
  )]));
            ...
            child: GetBuilder<MovieDetaleController>(
              ...
              builder: (controller) => Column(
                children: [
                      ...
                      SizedBox(
                        ...
                        child: ShapeOfView(
                            ...
                            child: CachedNetworkImage(
                                imageUrl:imagebase+ controller.model.posterPath.toString(),
                          ...
                          child: Row(
                              ...
                              children: [
                                IconButton(
                                    ...
                                    onPressed: () {}),
                                CustomText(
                                  text: controller.model.voteAverage!.toStringAsFixed(1),
                  ...
                  Padding(
                    ...
                    child: CustomText(
                      //align: TextAlign.center,
                        text: controller.model.title.toString(),
                        color: whiteColor,
                        size: width * 0.055,
                        maxline: 2,
                              ...
                              child: Column(children: [
                                ...
                                CustomText(
                                  text:
                                      ...
                                      //     ?
                                      controller.model.releaseDate.toString().substring(0, 4),
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    CustomText(
                                      ...
                                      text:
                                           controller.model.productionCountries ==
                                                   null
                                           ?
                                         'country'.tr
                          ...
                          SizedBox(
                              ...
                              child: Column(
                                ...
                                : 'seasons'.tr,
                                    ...
                                    const SizedBox(height: 3),
                                    CustomText(
                                      text: controller.model.isShow==false?
                                      controller.getTimeString(controller.model.runtime as int):controller.model.runtime.toString(),
                                      color: orangeColor,
                                      size: width * 0.04,
                                      weight: FontWeight.bold,
                                    )
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: SingleChildScrollView(
                          child: CustomText(
                        text: controller.model.overview.toString(),
                        //controller.detales.overview,
                        size: width * 0.036,
                        color: whiteColor,
                      )),
                  ...
                  controller.model.cast!.cast!.isNotEmpty?
                  ContentScrolling(
                    color: mainColor,
                  ...
                  controller.model.recomendation!.results!.isNotEmpty?
                  ContentScrolling(
                    color: orangeColor,
                    borderColor: orangeColor,
